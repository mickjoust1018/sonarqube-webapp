...
export function searchProjects(query: ProjectsQuery & { p?: number; ps?: number }): Promise<ProjectsResponse> {
...
export function updateProjectKey(data: {
  from: string
  to: string
}): Promise<void> {
...
export function removeProjectTag(data: {
  project: string
  tag: string
}): Promise<void> {
